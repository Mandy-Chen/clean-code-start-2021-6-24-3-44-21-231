...
import com.tw.academy.basic.$6_primitive_obsession.practiceOne.Adress;
...
public class DeliveryManagerTest {
    ...
    public void should_allocate_to_local_when_target_address_same_with_mailing_address() {
        ...
        DeliveryManager deliveryManager = new DeliveryManager(new Adress(mailingAddress), new Adress(targetAddress));
